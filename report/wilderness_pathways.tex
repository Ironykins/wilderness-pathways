...
The simulation was written in NetLogo 5.1. It consists of two major parts: the terrain, and the agents. The terrain is a procedurally generated, grid-based map, and agents are small objects that traverse this map.

\subsection{Terrain Generation}
Subsection text here.\cite{wolfram:voronoi}
